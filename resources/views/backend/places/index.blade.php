<x-admin-layout>
  ...
  <div class="mx-5 py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <a href="{{ route('admin.backend.places.create', ['region' => $region->id]) }}">
          <button type="button" class="text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 text-lg">名所登録</button>
        </a>
      </div>
  </div>
      ...
      <tbody>
        @forelse ($places as $place)
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <a href="{{ route('admin.backend.places.edit', ['region' => $region->id, 'place' => $place->id]) }}">
